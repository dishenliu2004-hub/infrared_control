...
HD_PWD='E:/hardware_curriculum_design/nec_pl_zynq_vrlV0.1/build/gree_ir_pynq_axi/gree_ir_pynq_axi.runs/design_1_gree_ir_axi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_gree_ir_axi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_gree_ir_axi_0_0.tcl
